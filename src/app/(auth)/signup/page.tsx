...
export default function SignupPage() {
  ...
  const [isSigningIn, setIsSigningIn] = useState(true); // Start with loading true
  ...
  useEffect(() => {
    const processSocialLogin = async (userCredential: UserCredential) => {
        ...
        if (!email) {
            toast({
                ...
                description: "Could not retrieve an email from your social account.",
                variant: "destructive"
            });
    ...
    const checkRedirect = async () => {
        try {
            ...
            if (result) {
                await processSocialLogin(result);
            } else {
                 ...
                 if (errorParam === 'no-account') {
                    ...
                    if (email && name) {
                        ...
                        toast({
                            title: "Welcome!",
                            description: "No account found. Please complete your profile to finish signing up.",
                        });
                    }
                 }
                setIsSigningIn(false);
    ...
    checkRedirect();
}, [router, toast, form, searchParams]);
  ...
  const handleSignup = async (values: SignupFormValues) => {
    try {
      ...
      if (currentUser && currentUser.email === values.email) {
          // This is a social sign-in user completing their profile
          await createUser({
            id: currentUser.uid,
            role: values.role,
  ...
  return (
    <div className="signup-container">
        ...
        <form onSubmit={form.handleSubmit(handleSignup)} className="form">
            ...
            <Button type="submit" className="signup-new-button" disabled={isSubmitting || isFetchingCollege || isSigningIn}>
        ...
        <div className="social-account-container">
            ...
            <div className="social-accounts">
                <button className="social-button google" onClick={() => handleSocialSignIn(googleProvider)} disabled={isSigningIn}>
                    <svg className="svg" xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 488 512">
                    <path d="M488 261.8C488 403.3 391.1 504 248 504 110.8 504 0 393.2 0 256S110.8 8 248 8c66.8 0 123 24.5 166.3 64.9l-67.5 64.9C258.5 52.6 94.3 116.6 94.3 256c0 86.5 69.1 156.6 153.7 156.6 98.2 0 135-70.4 140.8-106.9H248v-85.3h236.1c2.3 12.7 3.9 24.9 3.9 41.4z"></path>
                    </svg>
                </button>
                <button className="social-button github" onClick={() => handleSocialSignIn(githubProvider)} disabled={isSigningIn}>
